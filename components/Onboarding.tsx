...
const ONBOARDING_STEP_CONFIG: OnboardingStep[] = [
    ...
    {
        titleKey: 'onboardingAreaTitle',
        descKey: 'onboardingAreaDesc',
        icon: (
            <svg className="w-16 h-16 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
        titleKey: 'onboardingGenerateTitle',
        descKey: 'onboardingGenerateDesc',
        icon: (
            <svg className="w-16 h-16 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
        titleKey: 'onboardingMeditationTitle',
        descKey: 'onboardingMeditationDesc',
        icon: (
            <svg className="w-16 h-16 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const Onboarding: React.FC<OnboardingProps> = memo(({ onComplete }) => {
    ...
    const steps = useMemo(() => 
        ONBOARDING_STEP_CONFIG.map(step => ({
